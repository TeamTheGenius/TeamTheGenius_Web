...
const SignUp = () => {
  ...
  return (
    <div>
      <MobView>
        <div className="flex">
          <h1 className="pretendard font-bold font-head flex items-end">
            투두핀에
            <br />
            오신 것을 환영합니다
          </h1>
          <span className="pretendard text-sm ml-auto">
            <b className="nomal mr-1">*</b>는 필수 입력란입니다.
          </span>
        </div>
        <form onSubmit={formik.handleSubmit}>
          <ul className="py-6">
            <li className="mb50 flex flex-col">
